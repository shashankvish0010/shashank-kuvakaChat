...
//Using TS gives the advantage for type safety
interface users {
  name: string;
  socketId: string;
}

let usersInRoom: Map<string, users> = new Map(); //Used a Map data structure to store and get user data efficiently and fast compare to an array
